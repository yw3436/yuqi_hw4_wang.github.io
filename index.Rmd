...
For more information, please go to [About Me](about_me.html) to read my resume.
...
If you are interested in the dashboard I made for the `rnoaa` dataset, please go to [Dashboard](dashboard.html). The dashboard provides the information about weather of three places in the U.S.
